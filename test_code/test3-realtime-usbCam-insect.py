...
try:
    ...
    print("Edge TPU Delegate loaded successfully for bug detection.")
except Exception as e:
    print(f"Error loading Edge TPU delegate: {e}")
    exit(1)

# Load labels for bugs
with open("test_data/inat_insect_labels.txt", "r") as f:
    labels = f.readlines()
...
print("Starting real-time bug detection...")
