...
try:
    ...
    print("Edge TPU Delegate loaded successfully for plant detection.")
except Exception as e:
    print(f"Error loading Edge TPU delegate: {e}")
    exit(1)

# Load labels for plants
with open("test_data/inat_plant_labels.txt", "r") as f:
    labels = f.readlines()
...
print("Starting real-time plant detection...")
